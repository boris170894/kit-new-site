...
class NewsModel(models.Model):
    ...
    news_title = models.CharField(verbose_name='Заголовок', max_length=120)
    ...
    news_category = models.ForeignKey('CategoryModel', on_delete=models.PROTECT, verbose_name='Категория', blank=True, null=True)

    news_is_published = models.BooleanField(verbose_name='Опубликовать', default=False)
    news_is_worldskills = models.BooleanField(verbose_name='WorldSkills', default=False)
    news_is_library = models.BooleanField(verbose_name='Библиотека', default=False)
